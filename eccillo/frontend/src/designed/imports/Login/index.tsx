import svgPaths from "./svg-08oe0c8gne";

function LogoWhite() {
  return (
    <div className="h-[40px] relative shrink-0 w-[42.196px]" data-name="Logo_white">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42.1964 40">
        <g id="Logo_white">
...
function Logo() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-start left-[406px] top-[206px] w-[148px]" data-name="Logo">
      <LogoWhite />
...
function LogoTopSpacer() {
  return <div className="absolute h-[72px] left-[28px] opacity-0 right-[28px] top-[246px]" data-name="logo-top-spacer" />;
}
...
function Hero() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-center relative shrink-0 text-center text-white w-full" data-name="hero">
      <p className="font-['Georgia_Pro:Light_Italic',sans-serif] italic leading-[1.2] relative shrink-0 text-[44px] w-full">Welcome back</p>
      <p className="font-['Helvetica_Now_Display:Light',sans-serif] leading-[1.5] not-italic opacity-75 relative shrink-0 text-[16px] w-full">Sign in to continue to your account.</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[20px]" data-name="mail">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="mail" opacity="0.9">
          <path d={svgPaths.p32e4b800} id="Vector" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]" data-name="lock">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="lock" opacity="0.9">
          <path d={svgPaths.p3ad10700} id="Vector" stroke="var(--stroke-0, #1E1E1E)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-white h-[56px] relative rounded-[200px] shrink-0 w-full" data-name="password-field">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[20px] relative size-full">
          <Lock />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Helvetica_Now_Display:Light',sans-serif] leading-[normal] min-w-px not-italic opacity-65 relative text-[#1e1e1e] text-[16px]">Password</p>
          <Eye />
        </div>
      </div>
    </div>
...
function BtnSignIn() {
  return (
    <div className="bg-black content-stretch flex h-[56px] items-center justify-center relative rounded-[200px] shrink-0 w-full" data-name="btn-sign-in">
      <p className="[word-break:break-word] font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Sign In</p>
    </div>
  );
}
...
function Divider() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="divider">
      <LineLeft />
      <p className="[word-break:break-word] font-['Helvetica_Now_Display:Light',sans-serif] leading-[normal] not-italic opacity-60 relative shrink-0 text-[12px] text-white whitespace-nowrap">or</p>
      <LineRight />
    </div>
  );
}
...
function Social() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center justify-center relative shrink-0 w-full" data-name="social">
      <div className="bg-white content-stretch drop-shadow-[0px_18px_15px_rgba(131,119,198,0.11)] flex flex-col items-start px-[52px] py-[19px] relative rounded-[50px] shrink-0 w-[324px]" data-name="Google Button">
...
function LoginContent() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-[220px] right-[220px] top-[318px]" data-name="login-content">
      <Hero />
      <Fields />
      <BtnSignIn />
      <Divider />
      ...
      <p className="[word-break:break-word] font-['Helvetica_Now_Display:Light',sans-serif] leading-[0] not-italic opacity-75 relative shrink-0 text-[14px] text-center text-white w-full">
        ...
        <span className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[1.5]">Sign up</span>
      </p>
    </div>
  );
}
...
export default function Login() {
  return (
    <div className="bg-black relative size-full" data-name="Login">
      <Frame />
    </div>
  );
}